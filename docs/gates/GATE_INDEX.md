...
| P3 | Candidate clean reproducible build and UCI surface | IN_PROGRESS | Dedicated candidate, honest UCI surface, and the repeated Antichess-only bench digest pass locally; dual clean reproducibility is not yet certified |
